        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="breadcumb__wrapper">
                    <h3 class="breadcumb__title"> Referanslar </h3>
       ...
       <div class="row gy-4">
        <div class="col-lg-12">
          ...
          <?php 
            ...
            $referans=$database->prepare("SELECT * FROM `referanslar`");
            $referans->execute();
            $referans_listesi=$referans->fetchAll();
           
            foreach($referans_listesi as $referans)
            {
            ?>
              <div class="col-lg-4 col-md-6">
                  <div class="blog-item">
                      <div class="blog-item__thumb">
                          <h1 href="referans.php"><img src="<?php echo $referans["referans_resim"]; ?>" alt=""></h1>
                          
                      </div>
                    <div class="blog-item__content">
                         
                          <h3 class="blog-item__title"><a href="referans.php"><?php echo $referans["referans_baslik"]; ?></a></h3>
                    </div>
                    <div class="blog-item__content">
                         
                          <h7 class="blog-item__title"><a href="referans.php"><?php echo $referans["referans_icerik"]; ?></a></h7>
                    </div>
                  </div>
              </div> 
            <?php } ?>

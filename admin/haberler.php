        ...
        <div class="row">
         ...
         <div class="card col-md-6">
              <div class="card-header">
                <h3 class="card-title"><strong>haberler</strong></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              ?>
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="haberresim" class="form-control">
                  </div>
                  <div class="form-group">
                ...
                <div class="card-footer">
                  <button type="submit" name="haberekle" class="btn btn-secondary">Kaydet</button>
                </div>
              </form>
            </div> 
        </div>

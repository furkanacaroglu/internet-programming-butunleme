        ...
        <div class="row">
         ...
         <div class="card col-md-6">
              <div class="card-header">
                <h3 class="card-title"><strong>referanslar</strong></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              ?>
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="referansresim" class="form-control">
                  </div>
                  <div class="form-group">
                ...
                <div class="card-footer">
                  <button type="submit" name="referansekle" class="btn btn-secondary">Kaydet</button>
                </div>
              </form>
            </div> 
        </div>

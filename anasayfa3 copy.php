            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-menu ms-auto">
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Anasayfa <i class="icon-add-1"></i></a>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="breadcumb__wrapper">
                    <h3 class="breadcumb__title"> Blog Details </h3>
                    <ul class="breadcumb__list">
                        ...
                        <li class="breadcumb__item"><a href="blog-details.html" class="breadcumb__link"> Blog Post </a> </li>
                        <li class="breadcumb__item"> //</li>
                        <li class="breadcumb__item"> <span class="breadcumb__item-text"> Blog Details </span> </li>
                    </ul>
                </div>
            </div>
        </div>
